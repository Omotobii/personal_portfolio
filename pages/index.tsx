  ...
  return (
    <>
      ...
      <section className=' lg:px-40'>
          ...
          <section className=' fixed inset-x-0 top-0'>
            ...
            <nav className=' mx-8 sm:mx-24 lg:mx-64 py-1 sm:py-3 backdrop-blur-2xl bg-slate-600 bg-opacity-20 mt-10 m-auto p-4 border border-gray-900 flex justify-between rounded-2xl'>
              ...
              <div className=' block sm:flex sm:justify-between sm:gap-24'>
                ...
                <img src="/fullnameB.png" alt="web dp" className='h-8 animate-pulse' />
                </div>
        ...
        <section className='sm:px-40 leading-10'>
          <p className=' pt-32'><span className=' font-bold text-xl bg-gradient-to-r bg-clip-text text-transparent from-teal-600 to-pink-500'>Frontend Engineer </span><span className='text-white'>&#128188;</span></p>

          <p className=' dark:text-white font-bold'>Developing novel and meaningful solutions with a user first approach</p>
        ...
        <section className=' pb-14'>
          ...
          <div className=' h-20 sm:mx-28 bg-gradient-to-r from-violet-800 to-violet-900 mb-3 rounded-md'>
