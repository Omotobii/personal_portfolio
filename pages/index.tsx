      ...
      <section className=' lg:px-40'>
        ...
        <section className=''>
          ...
          <section className=' fixed inset-x-0 top-0'>
            ...
            <center>
            <nav className=' mx-8 sm:mx-24 lg:mx-64 pb-1 pt-2 sm:py-3 backdrop-blur-2xl bg-slate-600 dark:bg-slate-300 bg-opacity-20 mt-10 m-auto p-4 border border-gray-900 flex justify-between rounded-2xl'>
